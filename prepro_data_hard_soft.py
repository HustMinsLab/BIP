    ...
    for inst in file_list:
        ...
        for event in events:
            ...
            for cur_ent_id in ent_ids:
                temp = '[V1] '+ event_label_words[event_type]+' [V2] '+ trig_text +' [V3]'
                temp_inv = '[V1] '+ event_label_words[event_type]+' [V2] '+ trig_text +' [V3]'
                ...
                for ent_id in ent_ids:
                    ...
                    if cur_ent_id == ent_id:
                        temp += ' [V4] '+ ent_label_words[ent_type] + ' [V5] ' + new_ent_text + ' [V6] <mask>'
                        ...
                        temp += ' [V4] '+ ent_label_words[ent_type] + ' [V5] ' + new_ent_text + ' [V6] ' + ent_role
                ...
                for ent_id in ent_ids_inv:
                    ...
                    if cur_ent_id == ent_id:
                        temp_inv += ' [V4] '+ ent_label_words[ent_type] + ' [V5] ' + new_ent_text + ' [V6] <mask>'
                        
                        break
                            
                    else:
                        temp_inv += ' [V4] '+ ent_label_words[ent_type] + ' [V5] ' + new_ent_text + ' [V6] ' + ent_role
