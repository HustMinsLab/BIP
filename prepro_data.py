    ...
    for inst in file_list:
        ...
        for event in events:
            ...
            for cur_ent_id in ent_ids:
                ...
                temp_inv = 'For the '+ event_label_words[event_type]+' event triggered by the '+trig_text #倒序的模板
                for ent_id in ent_ids:
                    ...
                    if cur_ent_id == ent_id:
                        ...
                        temp += ', the '+ ent_label_words[ent_type]+', '+new_ent_text+', is ' + ent_role
                ...
                for ent_id in ent_ids_inv:
                    ...
                    if cur_ent_id == ent_id:
                        temp_inv += ', the '+ ent_label_words[ent_type]+', '+new_ent_text+', is <mask>'
                        
                        break
                            
                    else:
                        temp_inv += ', the '+ ent_label_words[ent_type]+', '+new_ent_text+', is ' + ent_role
